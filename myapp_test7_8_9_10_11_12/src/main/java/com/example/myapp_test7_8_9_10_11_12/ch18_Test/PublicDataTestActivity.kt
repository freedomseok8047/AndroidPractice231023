...
import com.example.myapp_test7_8_9_10_11_12.ch18_Test.adapter.MyAdapterRetrofit3
import com.example.myapp_test7_8_9_10_11_12.ch18_Test.model.publicModel.ItemListModel2
import com.example.myapp_test7_8_9_10_11_12.ch18_Test.retrofit.MyApplication3
import com.example.myapp_test7_8_9_10_11_12.databinding.ActivityPublicDataTestBinding
...
//            @Query("apiKey") apiKey : String,
        ...
        userListCall.enqueue(object : Callback<ItemListModel2> {
            //익명 클래스가, Callback , 레트로핏2에서 제공하는 인터페이스를 구현했고,
            // 반드시 재정의해야하는 함수들이 있음.
            // 변경4
            override fun onResponse(call: Call<ItemListModel2>, response: Response<ItemListModel2>) {
