package com.example.myapp_test7_8_9_10_11_12.ch8_Test
...
import com.example.myapp_test7_8_9_10_11_12.databinding.ActivityTest8Binding
        ...
        when (event?.action){
            MotionEvent.ACTION_DOWN -> {
                Log.d(TAG,"touch down event x:${event.x},event rawX:${event.rawX}"+
                        "event y:${event.x},event rawY:${event.rawX}")
