...
import com.example.myapp_test7_8_9_10_11_12.databinding.ActivityTestIntentBinding
//1번 화면 업
...
//            intent.putExtra("password","1234")
        ...
        // 인텐트: 시스템에 전달하는 메세지
        // 속성에 intent-filter : 무엇을 하는지를 나타내는 라벨링
        // 시스템이 해당 필터의 요소를 보고서 해당 외부앱을 연결 시켜줌

        binding.testBtn4.setOnClickListener{
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("geo: 37.7749,1274149"))
            // 현재, 지도 관련 앱이 다양하게 없어서, 아마도 기본 앱: 구글 맵이 나옴
            // 만약, 지도 관련 앱이 여러개 있다면, 특정 앱 선택이 가능함
