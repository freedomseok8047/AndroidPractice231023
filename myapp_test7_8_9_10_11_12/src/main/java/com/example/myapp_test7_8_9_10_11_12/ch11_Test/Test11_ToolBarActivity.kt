package com.example.myapp_test7_8_9_10_11_12.ch11_Test
...
import com.example.myapp_test7_8_9_10_11_12.databinding.ActivityTest11ToolBarBinding
...
class Test11_ToolBarActivity : AppCompatActivity() {
    ...
    // 툴바 붙이기 작업
        ...
        // 일반 텍스트 뷰와, 호환성을 고려한 뷰의 차이점 소개.
        // lineHeight (sdk 28 버전 이후로 추가된 기능)
//        binding.testView.lineHeight = 50

        //호환성을 고려한 텍스트 뷰에서, lineHeight 사용해보기
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        // 검색 뷰에, 이벤트 추가하기.
        val menuItem = menu?.findItem(R.id.toolbar_search)
