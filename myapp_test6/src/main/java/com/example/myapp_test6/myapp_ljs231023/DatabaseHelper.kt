...
(context, DATABASE_NAME, null, 1) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL("create table " + TABLE_NAME +
                "(ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT, EMAIL TEXT, PASSWORD TEXT, PHONE TEXT, ADDRESS TEXT, PROFILEURI TEXT)")
    }
    ...
    fun insertData(name: String?, email: String?, password : String?,
                   phone: String?, address: String?, profileUri: String?): Boolean {
        ...
        contentValues.put(COL_7, profileUri)
